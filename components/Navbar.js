  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 py-10 md:py-20">
      <div className="flex justify-between items-center fixed  top-0 w-3/4 z-50">
        ...
        <div
          className={`fixed top-0 left-0 w-2/3 h-full bg-white dark:bg-gray-800 z-50 transform transition-transform duration-300 ease-in-out md:hidden ${
        ...
        <div className={`flex flex-row space-x-12 hidden md:block`}>
          ...
          <a href={userData.socialLinks.twitter}>
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-twitter inline-block h-5 w-5"
              viewBox="0 0 16 16"
            >
